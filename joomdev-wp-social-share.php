<?php 
/*
	Plugin Name: WP ShareX
	Plugin URI: https://joomdev.com/wordpress-plugins/wp-sharex
	Description: WP ShareX is an advanced WordPress Social Share plugin enables you to add social share buttons on Posts and pages. You can assign buttons on Top of the Content, Bottom of the Content, Sidebar and on media. 
	Version: 1.0.0
	Author: JoomDev
...
define('JOOMDEV_WSS_MORE_LINK', 'https://www.joomdev.com/wordpress-plugins');
        ...
        <div class="joomdev-wss-options-box">
            ...
            <div class="joomdev-wss-options-box-main">
                <div class="joomdev-wss-options-box-actions-header">
                    ...
                    <a class="joomdev-wss-more-themes-plugins-link" href="<?php echo JOOMDEV_WSS_MORE_LINK; ?>" target="_BLANK"><i class="fa fa-shopping-cart"></i> More Themes &amp; Plugins</a>
                </div>
                        ...
                        <div class="joomdev-wss-options-box-options-single-option">
                                    ...
                                    <div class="joomdev-wss-singleselect-animation-container">
                                        ...
                                        <span class="joomdev-wss-url_shorting-box url_shorting_bit_ly" style="display:<?php echo $joomdev_wss_options['url_shorting'] == 'bit.ly' ? 'block' : 'none'; ?>;">
                                            <div class="joomdev-form-field">
                                                Create Bitly Access token and Username here <a target="_BLANK" href="https://app.bitly.com/Bhb3608LOoo/bitlinks/2zKnzXS?actions=accountMain&actions=settings&actions=advancedSettings&actions=apiSupport">Click</a>
                                            </div>
                                            <div class="joomdev-form-field">
                                                <label>
                                                    <span>Username</span>
                            ...
                            <div class="joomdev-wss-singleselect-animation-container">
                                ...
                                <span class="joomdev-wss-url_shorting-box url_shorting_goo_gl" style="display:<?php echo $joomdev_wss_options['url_shorting'] == 'goo.gl' ? 'block' : 'none'; ?>;">
                                                <div class="joomdev-form-field">
                                                    Create Google API Key here <a target="_BLANK" href="https://console.developers.google.com/flows/enableapi?apiid=maps_backend,geocoding_backend,directions_backend,distance_matrix_backend,elevation_backend,places_backend&reusekey=true">Click</a>
                                                </div>
                                                <div class="joomdev-form-field">
                                                    <label>
                                                        <span>API Key</span>
            ...
            <div data-tab="design" class="joomdev-wss-options-box-options-single" style="display:<?php echo $tab == 'design' ? 'block' : 'none'; ?>;">
                ...
                <div class="joomdev-wss-options-box-options-single-option joomdev-wss-animation-options-demo">
                    <div class="joomdev-wss-options-box-sided first-cell">
                ...
                <div class="joomdev-wss-options-box-options-single-option joomdev-wss-options-box-equal">
                    <div class="joomdev-wss-options-box-sided first-cell">
